        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <input type="hidden" value="<?= $fournisseur['RefFournisseur']; ?>" name="RefFournisseur">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input id="projectname" name="contactfournisseur" type="text" class="form-control"
                                value="<?= $fournisseur['contactfournisseur']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input id="projectname" name="rcfournisseur" type="text" class="form-control"
                                autocomplete="OFF" value="<?= $fournisseur['rcfournisseur']; ?>">
                        </div>
                    </div>
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input id="projectname" name="niffournisseur" type="text" class="form-control"
                                autocomplete="OFF" value="<?= $fournisseur['niffournisseur']; ?>">
                        </div>
                    </div>
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input id="projectname" name="banquefournisseur" type="text" class="form-control"
                                autocomplete="OFF" value="<?= $fournisseur['banquefournisseur']; ?>">
                        </div>
                    </div>
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input id="projectbudget" name="emailfournisseur" type="email" class="form-control"
                                autocomplete="OFF" value="<?= $fournisseur['emailfournisseur']; ?>">
                        </div>
                    </div>
