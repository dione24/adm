<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Modification Decaissement</h4>
                <form method="POST">
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control" list="datalistOptions" id="exampleDataList" name="RefDemande"
                                value="<?= $getDecaissement['RefDemande']; ?>">
                    ...
                    <input type="hidden" name="RefDecaissement" value="<?= $getDecaissement['RefDecaissement']; ?>">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input id="projectname" name="datedecaissement" type="date" class="form-control"
                                value="<?= $getDecaissement['datedecaissement']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input id="projectname" name="nomcomplet" type="text" class="form-control"
                                value="<?= $getDecaissement['nomcomplet']; ?>">
                        </div>
                    </div>
                    <div class="row mb-4">
                        <label for="projectdesc" class="col-form-label col-lg-2">Motif</label>
                        <div class="col-lg-10">
                            <textarea class="form-control" name="motifdecaissement"
                                rows="3"><?= $getDecaissement['motifdecaissement']; ?></textarea>
                        </div>
                    </div>
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-10">
                            <input id="projectbudget" name="montantdecaissement" type="text" class="form-control"
                                value="<?= $getDecaissement['montantdecaissement']; ?>" required>
                        </div>
                    </div>
